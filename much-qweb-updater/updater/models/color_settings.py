...
class ColorSettings(models.TransientModel):
    ...
    .o_home_menu_background {
      background-image: {{ $logo-background-url }}
        ...
        linear-gradient(to right bottom, {{ $primary-background-color }},
    ...
    primary_color = fields.Char(
        ...
        help="Odoo's primary color "
        "(usually the color used in the navbar and main components)",
        default="#875a7b",
    )
    ...
    accent_color = fields.Char(
        string="Accent Color",
        help="Odoo components accent color "
        "(usually the color for buttons and other small accents on the views)",
        default="#0c9f9c",
    )
    primary_background_color = fields.Char(
        string="Primary Background Color",
        help="Odoo's background primary color "
        "(color gradient that shows in the home page for the enterprise version)",
        default="#333333",
    )
    ...
    custom_secondary = fields.Boolean(
        ...
        help="Use custom secondary color or let Odoo calculate the secondary.",
        default=False,
    )
    ...
    def set_values(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param(
            "updater.secondary_background_color",
